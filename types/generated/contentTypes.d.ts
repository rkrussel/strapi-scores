...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    awayFinal: Schema.Attribute.Integer;
    awayTeam: Schema.Attribute.Relation<'oneToOne', 'api::team.team'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currentOuts: Schema.Attribute.Integer &
    ...
    gameStatus: Schema.Attribute.Enumeration<
      ['Active', 'Complete', 'Future', 'Postponed', 'Delayed', 'Canceled']
    >;
    homeFinal: Schema.Attribute.Integer;
    homeTeam: Schema.Attribute.Relation<'oneToOne', 'api::team.team'>;
    inningHalf: Schema.Attribute.Enumeration<['Top', 'Bottom']>;
    inningNumber: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
